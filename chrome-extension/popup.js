jQuery(document).ready(function() {
    chrome.tabs.getSelected(null, function (tab) {
        ...
        jQuery.get(api_url, function (data) {
            ...
            jQuery('#consumer').append( "<td style=\"width:30.5%\"> <b>Consumer</b><br /> Score: " + data['consumer']['score'] + "</td>" );
            jQuery('#consumer').append( "<td class='words'>" + data['consumer']['words'].join(', ') + "</td>" );
            jQuery('#prosumer').data('score', data['prosumer']['score'])
            jQuery('#prosumer').append( "<td> <b>Prosumer</b><br /> Score: " + data['prosumer']['score'] + "</td>" );
            ...
            jQuery('#self-serve').append( "<td> <b>Self Serve Business</b><br /> Score: " + data['self-serve business']['score'] + "</td>" );
            ...
            jQuery('#sales-assisted').append( "<td> <b>Sales Assisted Business</b><br /> Score: " + data['sales-assisted business']['score'] + "</td>" );
